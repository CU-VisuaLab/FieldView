...
public class EditorActivity extends AppCompatActivity implements
    ...
    String ServerURL = "http://cu-visualab.org/Fieldview/farrand.php";
    Button postBtn;
    EditText scorch_rate, user, lati, longi;
    String TempUser, TempScorchRate, TempLat, TempLong, TempImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scorch_rate = (EditText)findViewById(R.id.scorchEditText);
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetInput();
                InsertData(TempUser, TempScorchRate,TempLong, TempLat, TempImg);
            }
        });
    ...
    public void GetInput() {
        ...
        TempScorchRate = scorch_rate.getText().toString();
        TempLat = lati.getText().toString();
        TempLong = longi.getText().toString();
        TempImg = ImageName.getText().toString();
    }
     ...
     **/
    public void InsertData(final String user, final String scorch_rate, final String longitude, final String latitude, final String image_url) {
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String ScorchHolder = scorch_rate;
                String LongHolder = longitude;
                String LatHolder = latitude;
                String ImgHolder = image_url;

                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
                nameValuePairs.add(new BasicNameValuePair("user", UserHolder));
                nameValuePairs.add(new BasicNameValuePair("scorch_rate", ScorchHolder));
                ...
                nameValuePairs.add(new BasicNameValuePair("image_url",ImgHolder));
        ...
        sendPostReqAsyncTask.execute(user, scorch_rate, longitude, latitude);
    }
    ...
    private void finishEditing() {
        String newText = user.getText().toString().trim();
